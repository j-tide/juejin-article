...
3. [模型已经回答完了，Agent 为什么还没结束？](<03｜模型已经回答完了，Agent 为什么还没结束？/README.md>)
4. [模型看到的上下文，为什么要从日志里重新生成？](<04｜模型看到的上下文，为什么要从日志里重新生成？/README.md>)
5. [模型想调用工具，为什么不是直接执行？](<05｜模型想调用工具，为什么不是直接执行？/README.md>)
6. [点下“停止”以后，哪些事已经来不及撤回？](<06｜点下“停止”以后，哪些事已经来不及撤回？/README.md>)
7. [子 Agent 接到的，究竟是一句话还是一套运行环境？](<07｜子 Agent 接到的，究竟是一句话还是一套运行环境？/README.md>)
8. [把多次工具调用写成一段程序，PTC 到底改变了什么？](<08｜把多次工具调用写成一段程序，PTC 到底改变了什么？/README.md>)
9. [插件卸载了，它注册过的工具、监听器和任务怎么办？](<09｜插件卸载了，它注册过的工具、监听器和任务怎么办？/README.md>)
10. [创造模式在“创造”什么？让 Agent 组装一种新工作方式](<10｜创造模式在“创造”什么？让 Agent 组装一种新工作方式/README.md>)
